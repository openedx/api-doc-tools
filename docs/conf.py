...
"""
edx-api-doc-tools documentation build configuration file.
...
project = 'edx-api-doc-tools'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edX API Documentation Tools'
...
#
# html_title = 'edx-api-doc-tools v1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Tools for writing and generating API documentation for edX REST APIs',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_api_doc_tools'),
                os.path.join(root_path, 'edx_api_doc_tools/migrations')])
